...
function createCharts(data) {
    ...
    const chartData = {
        esgoto: { data: [0, 0, 0, 0], labels: ['Fossa Séptica', 'Fossa Comum', 'Fossa', 'Inexistente'] },
        agua: { data: [0, 0, 0, 0, 0, 0], labels: ['Potável', 'Rede Pública', 'Poço Artesiano', 'Cacimba', 'Fonte de Rio', 'Inexistente'] },
        energia: { data: [0, 0, 0, 0], labels: ['Rede Pública', 'Gerador Fóssil', 'Renovável', 'Inexistente'] },
        lixo: { data: [0, 0, 0, 0, 0], labels: ['Serviço de Coleta', 'Queima', 'Enterra', 'Destino Final Público', 'Descarta em Outra Área'] },
        internet: { data: [0, 0, 0, 0, 0], labels: ['Internet Geral', 'Alunos', 'Administrativo', 'Aprendizagem', 'Comunidade'] }
    };
    ...
    createChart('energiaChart', 'Energia Elétrica', chartData.energia.data, chartData.energia.labels, colors);
    createChart('LixoChart', 'Sistema de Coleta de Lixo', chartData.lixo.data, chartData.lixo.labels, colors);
    createChart('internetChart', 'Internet', chartData.internet.data, chartData.internet.labels, colors);
}
